...
const { newChat, getChat, getChatList, getai, speech, newSystemMessage, editBot, deleteBot, getSystemMessages, getOneSystemMessage, generateBotAvatar, avatar, setLastBotId, getLastBot, clearAvatar, forgetBot, getSharedUserData, updateSharedUserData } = require("./Chats");
...
router.route("/getSharedUserData").get(userAuth, getSharedUserData);
router.route("/updateSharedUserData").put(userAuth, updateSharedUserData);
